...
class Member extends CI_Controller
{
	...
	public function validasi_member($method)
	{
		...
		$this->form_validation->set_rules('username', 'ID', 'required|numeric|trim|min_length[8]|max_length[12]' . $u_username);
		...
		$this->form_validation->set_rules('seleksi', 'Futir', 'required');
		$this->form_validation->set_rules('kelas', 'Ujian Seleksi', 'required');
