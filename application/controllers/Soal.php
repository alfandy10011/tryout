...
class Soal extends CI_Controller {
    ...
    public function tryout(){
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('soal/tryout');
		$this->load->view('_templates/dashboard/_footer.php');
    }
    
    public function buatTryout(){
        $this->validasi();
        $this->load->helper('string');
    
        $tryout_id		= $this->input->post('tryout_id', true);
        $nama_tryout	= $this->input->post('nama_tryout', true);
        ...
        $this->master->create('m_tryout', $input);
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            foreach ($abjad as $abj) {
                ...
                $data['poin_'.$abj]    = $this->input->post('poin_'.$abj, true);
            }
