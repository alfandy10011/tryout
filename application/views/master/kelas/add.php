            ...
            <div class="col-sm-offset-3 col-sm-6">
                <div class="my-2">
                    <div class="form-horizontal form-inline">
                        <a href="<?=base_url('kelas')?>" class="btn btn-info btn-xs">
                    ...
                    <tbody>
                        <?php for ($i=1; $i <= $banyak; $i++) : ?> 
                            <tr>
                                ...
                                <td width="200">
                                    <div class="form-group">
                                        <select required="required" name="seleksi_id[<?=$i?>]" class="form-control input-sm select2" style="width: 100%!important">
                                            <option value="" disabled selected>-- Pilih --</option>
                                            <?php foreach ($seleksi as $j) : ?>
                                                <option value="<?=$j->id_seleksi?>"><?=$j->nama_seleksi?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <small class="help-block text-right"></small>
                                    </div>
                ...
                <button id="submit" type="submit" class="mb-4 btn btn-block btn-flat btn-primary">
