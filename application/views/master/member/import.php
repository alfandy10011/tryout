<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/member.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
                ...
                <?php if (isset($_POST['preview'])) : ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                                        if ($data['username'] == null || $data['nama'] == null || $data['email'] == null || $data['jenis_kelamin'] == null || $data['kelas_id'] == null) {
                                            $status = false;
                                        }
                                    endforeach;
                                }
                    ...
                    <?php if ($status) : ?>
                        ...
                        <?= form_open('member/do_import', null, ['data' => json_encode($import)]); ?>
