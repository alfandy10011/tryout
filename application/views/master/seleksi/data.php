<div class="card shadow mb-4">
    ...
    <div class="card-body">
		<div class="mt-2 mb-4">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</button>
            <a href="<?=base_url('seleksi/import')?>" class="btn btn-sm btn-success"><i class="fa fa-upload"></i> Import</a>
            <button type="button" onclick="reload_ajax()" class="btn btn-sm btn-info"><i class="fa fa-refresh"></i> Reload</button>
        ...
        <table id="seleksi" class="w-100 table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Seleksi</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
            ...
            <?=form_open('seleksi/add', array('id', 'tambah'));?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/seleksi/data.js"></script>