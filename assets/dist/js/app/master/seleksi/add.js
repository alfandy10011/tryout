...
$(document).ready(function () {
    if (banyak < 1 || banyak > 50) {
        ...
        window.location.href = base_url+"seleksi";
    } else {
        generate(banyak);
    }

    $('#inputs input:first').select();
    $('form#seleksi input').on('change', function () {
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input autocomplete="off" type="text" name="nama_seleksi[${i}]" class="input-sm form-control">
